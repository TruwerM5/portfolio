import { version, ref, watchEffect, watch, getCurrentInstance, useSSRContext, hasInjectionContext, unref, inject, defineComponent, mergeProps, createApp, effectScope, shallowReactive, reactive, getCurrentScope, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, defineAsyncComponent, computed, h, isReadonly, isRef, isShallow, isReactive, toRaw } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/vue@3.5.3/node_modules/vue/index.mjs';
...
import { createHooks } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { getContext } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/unctx@2.3.1/node_modules/unctx/dist/index.mjs';
import { sanitizeStatusCode, createError as createError$1 } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/h3@1.12.0/node_modules/h3/dist/index.mjs';
import { CapoPlugin, getActiveHead } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/unhead@1.10.4/node_modules/unhead/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderAttr, ssrInterpolate, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/vue@3.5.3/node_modules/vue/server-renderer/index.mjs';
import 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/vue-bundle-renderer@2.1.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/devalue@5.0.0/node_modules/devalue/index.js';
import 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/ufo@1.5.4/node_modules/ufo/dist/index.mjs';
import 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/@unhead+ssr@1.10.4/node_modules/@unhead/ssr/dist/index.mjs';
import '../runtime.mjs';
...
import 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/@unhead+shared@1.10.4/node_modules/@unhead/shared/dist/index.mjs';
...
async function applyPlugins(nuxtApp, plugins2) {
  ...
  async function executePlugin(plugin) {
    var _a3;
    const unresolvedPluginsForThisPlugin = ((_a3 = plugin.dependsOn) == null ? void 0 : _a3.filter((name) => plugins2.some((p2) => p2._name === name) && !resolvedPlugins.includes(name))) ?? [];
...
const unhead_plJkLwFIVL = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_eHLTB35FYT = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_PaTwR33nRR = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_plJkLwFIVL,
  router_eHLTB35FYT,
  revive_payload_server_PaTwR33nRR,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "bg-secondary text-white p-6" }, _attrs))}><div class="container mx-auto flex justify-between items-center"><div class="text-xl font-light uppercase"> Ilsur Khalimov </div><nav class="hidden md:block"><ul class="flex gap-x-4"><!--[-->`);
      ssrRenderList(headerLinks, (item) => {
        _push(`<li><a${ssrRenderAttr("href", item.link)} class="transition hover:text-primary">${ssrInterpolate(item.name)}</a></li>`);
      });
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-[140px] md:w-auto flex items-center gap-1 text-primary justify-center bg-white px-4 py-2 rounded-lg shadow transition-transform hover:-translate-y-2" }, _attrs))}><img${ssrRenderAttr("src", `/images/skills/${_ctx.skill.img}`)}${ssrRenderAttr("alt", _ctx.skill.name)} class="w-[25px] sm:w-[30px] lg:w-[45px]"><span class="text-lg md:text-2xl">${ssrInterpolate(_ctx.skill.name)}</span></div>`);
    };
  }
});
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/SkillChip.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "divider" }, _attrs))} data-v-1ebf5f92></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CurvedDivider.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-1ebf5f92"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-white rounded-lg shadow-lg overflow-hidden" }, _attrs))}><img${ssrRenderAttr("src", _ctx.project.image)}${ssrRenderAttr("alt", _ctx.project.name)} class="w-full h-[200px] object-cover object-top"><div class="p-6"><h3 class="text-primary text-xl mb-2">${ssrInterpolate(_ctx.project.name)}</h3><p class="text-gray-700 mb-4">${ssrInterpolate(_ctx.project.description)}</p><a${ssrRenderAttr("href", _ctx.project.link)} target="_blank" class="text-secondary font-semibold transform transition-all duration-300 hover:text-primary hover:ps-1"> View Project </a></div></div>`);
    };
  }
});
...
const _imports_0 = "" + __buildAssetsURL("vue-logo.CyU2rpZV.png");
const _imports_1 = "" + __buildAssetsURL("avatar.B6tBuirj.png");
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "app",
  __ssrInlineRender: true,
  setup(__props) {
    useSeoMeta({
      ogTitle: "Ilsur Khalimov's Portfolio",
    ...
    const contacts = [
      {
        id: 1,
        img: "linkedin.svg",
        href: "https://www.linkedin.com/in/ilsur-khalimov-9b59821b1/",
        name: "LinkedIn"
      },
      {
        id: 2,
        img: "telegram.svg",
        href: "https://t.me/raaydan",
        name: "Telegram"
      },
      {
        id: 3,
        img: "github.svg",
        href: "https://github.com/TruwerM5",
        name: "Github"
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_BaseHeader = _sfc_main$6;
      const _component_SkillChip = _sfc_main$5;
      const _component_CurvedDivider = __nuxt_component_2;
      const _component_ProjectShowcase = _sfc_main$3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-neutral" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_BaseHeader, null, null, _parent));
      _push(`<section class="bg-secondary text-white py-20"><div class="container grid md:grid-cols-2 gap-8"><div class="col-span-1 flex flex-col justify-center items-start"><h1 class="text-5xl mb-4">Hello! I&#39;m Ilsur</h1><p class="text-2xl mb-8">A fullstack developer specializing in Vue &amp; Nuxt.</p><button class="bg-primary text-white px-8 py-4 rounded-full hover:bg-opacity-90 transition duration-300"> View My Work </button></div><div class="col-span-1 flex justify-end"><img${ssrRenderAttr("src", _imports_0)} alt="Logo" class="w-full"></div></div></section><section id="skills" class="py-16 bg-neutral"><div class="container mx-auto text-center p-1"><img${ssrRenderAttr("src", _imports_1)} alt="Avatar" class="rounded-full w-48 h-48 mx-auto mb-6 shadow-xl border-4 border-dashed border-primary"><p class="text-gray-700 max-w-4xl mx-auto text-lg leading-loose mb-6 px-4"> Hello! I&#39;m Ilsur Khalimov, a fullstack developer with a passion for building performant and user-friendly web applications. With expertise in Vue.js and Nuxt.js, I take pride in crafting solutions that are not only functional but also elegantly coded. </p><div class="grid grid-cols-2 justify-items-center gap-2 mb-8 sm:grid-cols-3 md:grid-cols-4 sm:px-8 md:px-0"><!--[-->`);
      ssrRenderList(skills, (skill) => {
        _push(ssrRenderComponent(_component_SkillChip, {
          key: skill.id,
          skill
        }, null, _parent));
      });
      _push(`<!--]--></div></div></section>`);
      _push(ssrRenderComponent(_component_CurvedDivider, { class: "bg-[#f7f9fa]" }, null, _parent));
      _push(`<section id="projects" class="py-16 bg-slate-200"><h2 class="text-primary text-3xl mb-8 text-center">My Work</h2><div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12"><!--[-->`);
      ssrRenderList(projects, (project) => {
        _push(ssrRenderComponent(_component_ProjectShowcase, {
          key: project.name,
          project
        }, null, _parent));
      });
      _push(`<!--]--></div></section>`);
      _push(ssrRenderComponent(_component_CurvedDivider, { class: "bg-[#f7f9fa] rotate-180" }, null, _parent));
      _push(`<section id="contact" class="py-16"><h2 class="text-primary text-3xl mb-8 text-center">Contact</h2><div class="container mx-auto flex flex-wrap gap-8 justify-center"><!--[-->`);
      ssrRenderList(contacts, (contact) => {
        _push(`<a target="_blank"${ssrRenderAttr("href", contact.href)} class="flex-1 p-4 shadow-2xl text-center transition-all duration-500 hover:text-primary hover:-translate-y-4"><img${ssrRenderAttr("src", `/images/contact/${contact.img}`)}${ssrRenderAttr("alt", contact.name)} class="w-10 md:w-16 mx-auto"><span class="text-center text-sm md:text-2xl">${ssrInterpolate(contact.name)}</span></a>`);
      });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bwq8Et-7.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-CL3goi1-.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@22.5.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.21_gyumx2uughrkxfi3zhio7jcoaq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@22.5.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.21_gyumx2uughrkxfi3zhio7jcoaq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
