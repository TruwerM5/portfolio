import { mergeProps, useSSRContext } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/vue@3.5.3/node_modules/vue/index.mjs';
import { _ as _export_sfc, e as useHead } from './server.mjs';
import { ssrRenderAttrs, ssrInterpolate } from 'file:///home/kali/Documents/projects/Nuxt/my-portfolio/node_modules/.pnpm/vue@3.5.3/node_modules/vue/server-renderer/index.mjs';
import 'node:http';
import 'node:https';
import 'node:zlib';
import 'node:stream';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "font-sans antialiased bg-white dark:bg-black text-black dark:text-white grid min-h-screen place-content-center overflow-hidden" }, _attrs))} data-v-f3dfb7fd><div class="fixed -bottom-1/2 left-0 right-0 h-1/2 spotlight" data-v-f3dfb7fd></div><div class="max-w-520px text-center" data-v-f3dfb7fd><h1 class="text-8xl sm:text-10xl font-medium mb-8" data-v-f3dfb7fd>${ssrInterpolate(__props.statusCode)}</h1><p class="text-xl px-8 sm:px-0 sm:text-4xl font-light mb-16 leading-tight" data-v-f3dfb7fd>${ssrInterpolate(__props.description)}</p></div></div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.13.1_@parcel+watcher@2.4.1_@types+node@22.5.4_ioredis@5.4.1_magicast@0.3.5_rollup@4.21_gyumx2uughrkxfi3zhio7jcoaq/node_modules/nuxt/dist/app/components/error-500.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f3dfb7fd"]]);

export { error500 as default };
//# sourceMappingURL=error-500-CL3goi1-.mjs.map
